Param(
    ...
    $solrSSL = $true,
    $nssmVersion = "2.24",
    $OpenJDKVersion = "11.0.2"
)

$JREPath = "C:\Program Files\OpenJDK\jdk-$OpenJDKVersion" ## Note that if you're running 32bit open JDK java, you will need to change this path
