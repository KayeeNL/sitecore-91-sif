Param(
    ...
    $solrSSL = $true,
    $nssmVersion = "2.24",
    $AdoptOpenJDKVersion = "8u212-b03"
)

$JREPath = "C:\Program Files\AdoptOpenJDK\jdk$AdoptOpenJDKVersion" ## Note that if you're running 32bit open JDK java, you will need to change this path
...
# Ensure Java environment variable, when we're using OpenJDK as well instead of JRE, the JAVA_HOME variable just gets adjusted
